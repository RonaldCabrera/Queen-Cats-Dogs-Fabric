...
public class PrincessCatEntity extends HumanoidCatEntity{
    private final EntityType<QueenCatEntity> grownEntity = ModEntities.QUEEN_CAT;

    public PrincessCatEntity(EntityType<? extends HumanoidCatEntity> entityType, World world) {
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
        var variant = Util.getRandom(HumanoidCatVariant.values(), this.random);
        setVariant(variant);
