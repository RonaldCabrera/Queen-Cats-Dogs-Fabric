...
public class QueenCowEntity extends HumanoidCowEntity{
    public QueenCowEntity(EntityType<? extends HumanoidAnimalEntity> entityType, World world) {
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        PrincessCowEntity baby = ModEntities.PRINCESS_COW.create(world);
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if (itemstack.isOf(Items.BOWL) && this.isStewableVariant()) {
        ...
        if (item == itemForTaming && isTamed() && this.getHealth() < getMaxHealth() && !player.isSneaking()) {
            if (this.world.isClient()) {
                ...
                if (!this.world.isClient()) {
                    ...
                    this.playSound(getEatSound(itemstack), 1.0f, 1.0f);
                }
