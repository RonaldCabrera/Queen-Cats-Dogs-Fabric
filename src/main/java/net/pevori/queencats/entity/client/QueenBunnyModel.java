...
public class QueenBunnyModel extends AnimatedGeoModel<QueenBunnyEntity> {
    @Override
    public Identifier getModelLocation(QueenBunnyEntity object) {
    ...
    @Override
    public Identifier getTextureLocation(QueenBunnyEntity object) {
        return QueenBunnyRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public Identifier getAnimationFileLocation(QueenBunnyEntity animatable) {
