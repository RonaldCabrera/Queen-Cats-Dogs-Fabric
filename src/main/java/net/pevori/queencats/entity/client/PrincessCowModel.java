...
public class PrincessCowModel extends AnimatedGeoModel<PrincessCowEntity> {
    @Override
    public Identifier getModelLocation(PrincessCowEntity object) {
        return new Identifier(QueenCats.MOD_ID, "geo/humanoid_cow_children.geo.json");
    }

    @Override
    public Identifier getTextureLocation(PrincessCowEntity object) {
        return PrincessBunnyRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public Identifier getAnimationFileLocation(PrincessCowEntity animatable) {
