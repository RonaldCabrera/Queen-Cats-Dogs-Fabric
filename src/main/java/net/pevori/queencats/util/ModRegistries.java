...
public class ModRegistries {
    ...
    private static void registerAttributes() {
        ...
        FabricDefaultAttributeRegistry.register(ModEntities.QUEEN_BUNNY, QueenBunnyEntity.setAttributes());
        FabricDefaultAttributeRegistry.register(ModEntities.PRINCESS_BUNNY, PrincessBunnyEntity.setAttributes());
